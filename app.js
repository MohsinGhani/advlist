...
var Advertise = (function () {
    function Advertise(name, model, color, price, description) {
        this.name = name;
        this.model = model;
        this.price = price;
        this.color = color;
...
var Mobile = (function (_super) {
    ...
    function Mobile(name, model, color, price, description) {
        _super.call(this, name, model, color, price, description);
...
var Car = (function (_super) {
    ...
    function Car(name, model, color, price, description) {
        _super.call(this, name, model, color, price, description);
...
var Bike = (function (_super) {
    ...
    function Bike(name, model, color, price, description) {
        _super.call(this, name, model, color, price, description);
